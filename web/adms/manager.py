...
class ManagerLogin(Resource):
    def __init__(self, client, db, bde_collection, manager_collection, mentor_collection, student_collection):
        super().__init__()
        self.client = client
        self.db_name = db
    ...
    def post(self):
        ...
        return {"message": "Student added successfully", "manager": manager_data}, 200

    def put(self):
        data = request.json
        print('Manager-PUT-----',data)
        id = data.get("id")
